...
```--project``` argument is specified to project using TSNE. Remove this argument if you don't want to project the data. If you wish to use 2 dimension for TSNE instead of 3 (default), specify ```--tsne_dim 2```.  
